...
public class TestCities {
    ...
    public void equals_tests() {
        ...
        System.out.println("Portugal:Faro - 202Km2:64560");
    ...
    public void population_change_tests() {
        ...
        assertEquals(193948, FARO.populationChange(1.1));
        assertEquals(23750, FARO.populationChange(-1.0));
    ...
    public void getCity_tests() {
        ...
        assertNotEquals( FARO, faro );      // usa o equals de Object (compara referencias)

        City ny = City.getCity( "Estados Unidos:Nova York - 783km2:8419000" );
        testGetters(ny, "Nova York", "Estados Unidos",  8419000, 783);
        assertNotEquals( NOVA_YORK, ny  );  // usa o equals de Object (compara referencias)
    }
    ...
    public void smaller_cities_tests() {
        ...
        assertEquals( FARO, City.smallerCities(firstFiveCities) );

        City[] firstEightCities = getCities(8);

        assertEquals( LEIRIA, City.smallerCities(firstEightCities));

        City[] allCities = getCities(descriptions.length);
        City lastCity = City.getCity(descriptions[descriptions.length-1]);
        assertEquals( lastCity, City.smallerCities(allCities));
